...
@section('title')
<x-breadcrumb :indexPage="'Címkék a fotókhoz'" :pageTitle="'Címke létrehozása'" :indexPageRoute="'tag.index'">
</x-breadcrumb>
<div class="w-full bg-sky-100 p-4">
    <h1 class="mb-3 text-left font-serif text-2xl font-bold">{{ __('Címke létrehozása') }}</h1>
</div>
@endsection
