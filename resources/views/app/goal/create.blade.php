...
@section('title')
    <x-breadcrumb :indexPage="__('Bakancslista')" :pageTitle="__('Bakancslista bővítése')" :indexPageRoute="'goal.index'">
    </x-breadcrumb>
@endsection
                ...
                <form action="{{ route('goal.store') }}" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
                    ...
                    <div class="mb-5 mt-2 block">
                        <h1 class="border-b border-b-gray-200 pb-3 text-left font-serif text-3xl font-bold">
                            {{ __('Bakancslista bővítése') }}
                        </h1>
                    </div>
                    <div class="mb-5 block">
                        <label for="title" class="form-label text-gray-900">{{ __('Rövid cím') }}</label>
                    ...
                    <div class="mb-5 block">
                        <label for="description" class="form-label text-gray-900">{{ __('Rövid leírás') }}</label>
                        <textarea
                    ...
                    <div class="mb-5 block">
                        <label for="image"
                            class="form-label mb-2 inline-block text-gray-900">{{ __('Kép feltöltése') }}</label>
                        <input
