        ...
        @if (Route::has('login'))
            @auth
                ...
                @if (auth()->user()->role === 'admin')
                    <li
                        class="border-light-border {{ Request::is('*admin') ? ' bg-white' : '' }} h-full w-full border-b py-3 px-2">
                        <a href="{{ route('admin.index') }}"
                            class="text-nav-item {{ Request::is('*admin') ? ' font-bold' : '' }} font-sans text-base no-underline hover:text-sky-800">
                    ...
                    <li
                        class="border-light-border {{ Request::is('*admin/create') ? ' bg-white' : '' }} h-full w-full border-b py-3 px-2">
                        <a href="{{ route('admin.create') }}"
                            class="text-nav-item {{ Request::is('*admin/create') ? ' font-bold' : '' }} font-sans text-base no-underline hover:text-sky-800">
                            <i class="fas fa-solid fa-user mx-2"></i>
                            {{ __('New User') }}
                        </a>
                    </li>
                    <li
