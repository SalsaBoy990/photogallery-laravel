...
/* harmony import */ var _photogallery_custom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./photogallery/custom */ "./resources/js/photogallery/custom.js");
/* harmony import */ var _photogallery_custom__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_photogallery_custom__WEBPACK_IMPORTED_MODULE_1__);
...
window.lightGallery = lightgallery__WEBPACK_IMPORTED_MODULE_2__["default"]; // Plugins for the image gallery


window.lgThumbnail = lightgallery_plugins_thumbnail__WEBPACK_IMPORTED_MODULE_3__["default"];

window.lgZoom = lightgallery_plugins_zoom__WEBPACK_IMPORTED_MODULE_4__["default"];
...
/***/ "./resources/js/photogallery/custom.js":
/*!*********************************************!*\
  !*** ./resources/js/photogallery/custom.js ***!
  \*********************************************/
/***/ (() => {
...
var photoGalleryContainer = document.querySelector("#lightgallery");

if (photoGalleryContainer) {
  var photoGalleryInstance = lightGallery(photoGalleryContainer, {
    plugins: [window.lgZoom, window.lgThumbnail]
  });
  var openGalleryButton = document.querySelector("#open-light-gallery-button");
